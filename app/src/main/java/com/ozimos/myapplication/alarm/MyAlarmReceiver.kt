...
import com.ozimos.myapplication.BuildConfig
...
class MyAlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        private const val ID_ONETIME = 1000
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val notifID = if (type.equals(TYPE_ONE_TIME)) ID_ONETIME else ID_REPEATING
    ...
    fun setOneTimeAlarm(
        ...
        if (isDateValid(date = date, DATE_FORMAT) || isDateValid(date = time, TIME_FORMAT)) return
    ...
    private fun showAlarmNotif(context: Context, title: String, message: String, notifId: Int) {
        val channelID = "ChannelAlarmID"
        val channelName = "Alarm Manager Channel"

        val notifManagerCompact =
    ...
    private fun isDateValid(date: String, dateFormat: String): Boolean {
        return try {
